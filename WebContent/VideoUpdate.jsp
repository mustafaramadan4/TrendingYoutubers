...
style="background-image: url('background.jpeg');
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-warning">
  		...
  		<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    		<div class="navbar-nav">
      			...
      			<a class="nav-item nav-link active" id="videoUpdate" href="videoupdate"><img src="icon4.png" alt="icon4" height=30px>Update Video</a>
   			 </div>
  		</div>
	</nav>
	...
	<h1 class="d-flex justify-content-center">Update Video</h1>
	</div>
	...
	<div class="alert alert-info" role="alert">
		...
		<p class="d-flex justify-content-center">
			<label for="views">New Views</label>
