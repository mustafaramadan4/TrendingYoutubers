...
style="background-image: url('background.jpeg');
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-warning">
  		...
  		<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    		<div class="navbar-nav">
      			...
      			<a class="nav-item nav-link active" id="videoDelete" href="videodelete"><img src="icon3.png" alt="icon3" height=30px>Delete Video</a>
	...
	<h1 class="d-flex justify-content-center">${messages.title}</h1>
	</div>
	<form action="videodelete"  method="post">
		<div class="d-flex justify-content-center">
			<div class="alert alert-info" role="alert" <c:if test="${messages.disableSubmit}">style="display:none"</c:if>>
